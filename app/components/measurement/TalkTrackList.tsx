      ...
      {talkTrackSnippets.map((snippet) =>
        snippet.isAvoid ? (
          <div key={snippet.id} className="rounded-card border border-dashed border-line bg-paper-2 p-4">
            <p className="mb-2 text-caption font-medium uppercase tracking-wide text-ink/50">Avoid saying this</p>
          ...
          <div key={snippet.id}>
            <p className="mb-2 text-caption font-medium uppercase tracking-wide text-forest">Correlation-safe framing</p>
