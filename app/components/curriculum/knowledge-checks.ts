import { KnowledgeCheckQuestion, M1_KNOWLEDGE_CHECK, M2_KNOWLEDGE_CHECK, M9_PROMPT_TAXONOMY_KNOWLEDGE_CHECK } from "./lessons/knowledge-check-data";
...
export const knowledgeChecks: Record<string, KnowledgeCheckQuestion[]> = {
  ...
  "em-sa:m9": M9_PROMPT_TAXONOMY_KNOWLEDGE_CHECK,
};
