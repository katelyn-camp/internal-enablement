  ...
  return (
    <div className="rounded-card border border-line bg-white p-5">
      ...
      <div className="space-y-3 border-t border-line pt-3 text-right text-sm leading-relaxed">
        <div>
          <div className="font-medium text-ink">What the audit found</div>
          <div className="text-ink/70">{example.auditFinding}</div>
        </div>
        <div>
          <div className="font-medium text-ink">Why this mix</div>
  ...
  return (
    <div>
      <div className="mx-auto mb-6 max-w-2xl rounded-card border border-line bg-paper-2 p-4 text-sm leading-relaxed text-ink/80">
        <span className="font-medium text-ink">Bespoke channel mix:</span> Services provides a bespoke
      ...
      <p className="mb-8 text-center text-caption font-medium tracking-wide text-ink/40 uppercase">
          ...
          <table className="w-full min-w-[480px] border-collapse text-xs">
            <thead>
              <tr className="border-b border-line text-left text-[0.7rem] tracking-wide text-ink/45 uppercase">
                ...
                {CHANNEL_ORDER.map((channel) => (
                  <th key={channel} className="py-1.5 pr-3 font-medium">
                    {channel}
                  </th>
                ))}
              </tr>
