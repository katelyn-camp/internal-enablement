...
export default function EmSaIndexPage() {
  return (
    <div className="mx-auto max-w-6xl px-5 py-10 lg:px-8 lg:py-14">
      ...
      <h1 className="font-display text-h1 lg:text-display mb-4 max-w-2xl text-ink">Delivery Team Curriculum</h1>
      <p className="mb-10 max-w-2xl text-sm leading-relaxed text-ink/70 lg:text-base">
        ...
        advanced, account-facing specialization. Services modules go to comprehensive depth: you&rsquo;re
