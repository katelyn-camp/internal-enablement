...
import {
  ...
  M12_MULTI_BRAND_MA_KNOWLEDGE_CHECK,
  M13_COMPLIANCE_REGULATED_INDUSTRIES_KNOWLEDGE_CHECK,
...
const KNOWLEDGE_CHECKS: Record<string, { tableId: string; questions: KnowledgeCheckQuestion[] }> = {
  ...
  "m12-multi-brand-ma": { tableId: "tblvfdufmP9Y7AXX1", questions: M12_MULTI_BRAND_MA_KNOWLEDGE_CHECK },
  "m13-compliance-regulated-industries": { tableId: "tblS3f84wRi8Y3MbR", questions: M13_COMPLIANCE_REGULATED_INDUSTRIES_KNOWLEDGE_CHECK },
