...
project brief for the full rationale. Fraunces (display) and Inter (body)
are placeholders for AirOps' actual licensed typefaces; swap in
`app/layout.tsx` once design confirms the real ones.
